...
export default function AsideBoards() {
    ...
    return (
        <div className='fixed top-20 z-[9999] left-[15%] px-6 sm:px-10 md:px-0 bg-[#2b2c37] md:bg-transparent md:relative md:top-0 md:left-[0] py-6 rounded-lg md:rounded-none'>
