...
export default function Header() {
    ...
    const {editBoardmodal, editModal, boardsModal, deleteBoardModal, addColumnModal, addTaskModal, showTaskModal, deleteTaskModal, editTaskModal } = modals

    return (
        <div className={`${boardsModal || editBoardmodal || editModal || deleteBoardModal || addColumnModal || addTaskModal || showTaskModal || deleteTaskModal || editTaskModal ? 'opacity-40 delay-100 transition-all ease-linear' : ' delay-100 transition-all ease-linear'} bg-[#2b2c37] h-[6rem] flex items-center sticky top-0 z-[9999]`}>
